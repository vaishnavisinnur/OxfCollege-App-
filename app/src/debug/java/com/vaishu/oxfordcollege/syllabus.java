...
public class syllabus extends AppCompatActivity  implements View.OnClickListener {
    ...
    private void gotoUrl(String s) {
        try {
            ...
            Toast.makeText(syllabus.this, "please select a browse to open link", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(syllabus.this, "no website linked", Toast.LENGTH_SHORT).show();
        }
    }
    }